...
func TestAccNetworkServicesLbTrafficExtension_crossRegionInternalPluginExtension(t *testing.T) {
	...
	acctest.VcrTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				Config: testAccNetworkServicesLbTrafficExtension_crossRegionInternalPluginExtension(context),
			},
			{
				ResourceName:            "google_network_services_lb_traffic_extension.default",
				ImportState:             true,
...
func testAccNetworkServicesLbTrafficExtension_crossRegionInternalPluginExtension(context map[string]interface{}) string {
...
func TestAccNetworkServicesLbTrafficExtension_globalExternalPluginExtension(t *testing.T) {
	t.Parallel()
	...
	acctest.VcrTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				Config: testAccNetworkServicesLbTrafficExtension_globalExternalPluginExtension(context),
			},
			{
				ResourceName:            "google_network_services_lb_traffic_extension.default",
				ImportState:             true,
...
func testAccNetworkServicesLbTrafficExtension_globalExternalPluginExtension(context map[string]interface{}) string {
	return fmt.Sprint(testAccNetworkServicesWasmPlugin_artifactRegistryRepositorySetup(context), acctest.Nprintf(`
# forwarding rule
resource "google_compute_global_forwarding_rule" "default" {
  name                  = "tf-test-l7-ilb-forwarding-rule%{random_suffix}"
...
func TestAccNetworkServicesLbTrafficExtension_httpRouteTarget(t *testing.T) {
	t.Parallel()
	...
	acctest.VcrTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccNetworkServicesLbTrafficExtension_httpRouteTarget(context),
			},
			{
				ResourceName:            "google_network_services_lb_traffic_extension.default",
				ImportState:             true,
...
func testAccNetworkServicesLbTrafficExtension_httpRouteTarget(context map[string]interface{}) string {
	return acctest.Nprintf(`
# Internal HTTP load balancer with a managed instance group backend
# VPC network
resource "google_compute_network" "ilb_network" {
  name                    = "tf-test-l7-ilb-ilb-network%{random_suffix}"
  auto_create_subnetworks = false
}
...
# MIG
resource "google_compute_region_instance_group_manager" "mig" {
  name     = "tf-test-l7-ilb-mig%{random_suffix}"
  region   = "us-west1"
...
resource "google_network_services_http_route" "default" {
  name                   = "tf-test-l7-ilb-http-route%{random_suffix}"
  labels                 = {
    foo = "bar"
  }
...
resource "google_compute_instance" "vm_test" {
  name         = "tf-test-l7-ilb-vm-test%{random_suffix}"
  zone         = "us-west1-b"
  machine_type = "e2-small"
...
# Traffic Extension Backend Instance
resource "google_compute_instance" "callouts_instance" {
  name         = "tf-test-l7-ilb-callouts-instance%{random_suffix}"
  zone         = "us-west1-a"
  machine_type = "e2-small"
...
// callouts instance group
resource "google_compute_instance_group" "callouts_instance_group" {
  name        = "tf-test-l7-ilb-callouts-instance-group%{random_suffix}"
  description = "Terraform test instance group"
  zone        = "us-west1-a"
